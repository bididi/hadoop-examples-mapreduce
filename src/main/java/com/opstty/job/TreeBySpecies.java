...
public class TreeBySpecies {
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "tbs");
        job.setJarByClass(com.opstty.job.TreeBySpecies.class);
        job.setMapperClass(TBSMapper.class);
        job.setCombinerClass(TBSReducer.class);
